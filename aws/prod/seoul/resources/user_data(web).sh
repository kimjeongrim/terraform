...
# set RDS IP
# RDS_ENDPOINT=RDS_ENDPOINT=$(terraform output -raw seoul_db_ep)
...
sudo sed -i 's/localhost/ogurim-db.cd4qy6s265xk.ap-northeast-2.rds.amazonaws.com/g' /var/www/html/wp-config.php
